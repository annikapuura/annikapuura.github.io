...
(function () {
    ...
    var OnePageNav = function () {
        var navToggler = $('.annika-js-nav-toggle');
        $(".smoothscroll[href^='#'], #annika-navbar ul li a[href^='#']").on('click', function (e) {
            e.preventDefault();
            var hash = this.hash;
            $('html, body').animate({
        ...
        $("#annika-navbar ul li a[href^='#']").on('click', function (e) {
    ...
    $(window).scroll(function () {
        var $this = $(this)
            , st = $this.scrollTop()
            , navbar = $('.annika-header')
            , logo = $(".annika-header .logo> img");
        if (st > 150) {
    ...
    $('.annika-js-nav-toggle').on('click', function (e) {
        var $this = $(this);
        e.preventDefault();
        if ($('body').hasClass('menu-open')) {
            $this.removeClass('active');
            $('.annika-menu .annika-menu-inner > ul > li').each(function (i) {
                var that = $(this);
                setTimeout(function () {
            ...
            setTimeout(function () {
                $('.annika-menu').removeClass('annika-menu-show');
            }, 800);
            $('body').removeClass('menu-open');
        }
        else {
            $('.annika-menu').addClass('annika-menu-show');
    ...
    $('.annika-menu .dropdown').hover(function () {
        var $this = $(this);
        $this.addClass('show');
